...
RSpec.describe Sort::NextDirectionForHelper, type: :helper do
  before(:each) do
  ...
  describe '.next_sort_direction_for' do
    subject { helper.next_sort_direction_for(attribute, format: format) }
