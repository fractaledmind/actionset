  ...
  describe '.pagination_links_for' do
    ...
    context 'total pages is 1' do
      ...
      context 'when page number is first/last page' do
        ...
        it { should have_selector('.pagination > .page-link.page-first.disabled',
                                  text: '« First') }
        it { should have_selector('.pagination > .page-link.page-prev.disabled',
                                  text: '‹ Prev') }
        it { should have_selector('.pagination > .page-current') }
        it { should match(/Page.*?#{page_number}.*?of.*?1/) }
        it { should have_selector('.pagination > .page-link.page-next.disabled',
                                  text: 'Next ›') }
        it { should have_selector('.pagination > .page-link.page-last.disabled',
                                  text: 'Last »') }
      end
      ...
      context 'when page number is greater than first/last page' do
        ...
        it { should have_selector('nav.pagination') }
        it { should have_selector('.pagination > .page-link.page-first',
                                  text: '« First') }
        it { should have_selector('.pagination > .page-link.page-prev.disabled',
                                  text: '‹ Prev') }
        it { should have_selector('.pagination > .page-current') }
    ...
    context 'total pages is 2' do
      ...
      context 'when page number is first page' do
        ...
        it { should have_selector('.pagination > .page-link.page-next',
                                  text: 'Next ›') }
        it { should have_selector('.pagination > .page-link.page-last',
                                  text: 'Last »') }
      end
      ...
      context 'when page number is last page' do
        ...
        it { should have_selector('.pagination > .page-link.page-first',
                                  text: '« First') }
        it { should have_selector('.pagination > .page-link.page-prev',
                                  text: '‹ Prev') }
        it { should have_selector('.pagination > .page-current') }
        it { should match(/Page.*?#{page_number}.*?of.*?2/) }
        it { should have_selector('.pagination > .page-link.page-next.disabled',
