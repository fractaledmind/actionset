    ...
    context 'on the base object' do
      ...
      context 'when direction is ASC' do
        ...
        context 'with default case-sensitive sort' do
          let(:sort_param) { { 'calculated_bignum_field': direction } }
          let(:expected_ids) do
            Foo.all
               .sort_by(&:calculated_bignum_field)
               .map(&:id)
          end
        ...
        context 'with case-INsensitive sort' do
          let(:sort_param) { { 'calculated_bignum_field(i)': direction } }
          let(:expected_ids) do
            Foo.all
               .sort_by { |x| x.calculated_bignum_field.to_s.downcase }
               .map(&:id)
          end
    ...
    context 'on an associated object' do
      ...
      context 'when direction is ASC' do
        ...
        context 'with default case-sensitive sort' do
          ...
          let(:expected_ids) do
            Foo.all
               .sort_by { |x| x.assoc.calculated_bignum_field }
               .map(&:id)
          end
        ...
        context 'with case-INsensitive sort' do
          ...
          let(:expected_ids) do
            Foo.all
               .sort_by { |x| x.assoc.calculated_bignum_field.to_s.downcase }
               .map(&:id)
          end
